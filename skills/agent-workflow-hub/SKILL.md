...
Pass the user's current repository/worktree through `--worktree`; do not ask the user for the script path. The primary and compatibility packages use the same schema and behavior. Do not require MCP.
